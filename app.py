    ...
    projects = [
        {
            ...
            "problem": "Understand income distribution and education access across provinces.",
            "method": "Cleaned 10,000+ rows, grouped by province, built heatmaps.",
            "result": "Found Province 2 had lowest literacy rates — visualized gap clearly.",
            "github": "https://github.com/yourusername/nepal-survey",
            "chart": "bar",
        },
        {
        ...
        },
        {
            ...
            "problem": "Track Nepal COVID cases over time vs. vaccination rates.",
            "method": "Fetched open API data, time-series plots, rolling 7-day averages.",
        ...
        with st.container():
            ...
            with col1:
                ...
                <table style='font-size:13px;color:#374151;width:100%'>
                  <tr><td style='color:#9ca3af;padding-right:8px;white-space:nowrap'>Problem</td><td>{p['problem']}</td></tr>
                  <tr><td style='color:#9ca3af;padding-right:8px;white-space:nowrap'>Method</td><td>{p['method']}</td></tr>
                  <tr><td style='color:#9ca3af;padding-right:8px;white-space:nowrap'>Result</td><td>{p['result']}</td></tr>
                </table>
                ...
                """, unsafe_allow_html=True)
            with col2:
                # Generate a sample chart for each project
                np.random.seed(42)
                if p["chart"] == "bar":
                    ...
                    fig = px.line(x=x, y=np.cumsum(np.random.randn(60) + 1),
                                  height=220, labels={"x": "Date", "y": "Cases"})
